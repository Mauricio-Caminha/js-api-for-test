...
describe('ProductService', () => {
  ...
  describe('createProduct', () => {
    it('should create a new product', async () => {
      ...
      expect(newProduct).toEqual({ id: '4', ...newProductData });
  ...
  describe('updateProduct', () => {
    it('should update an existing product', async () => {
      ...
      expect(updatedProduct).toEqual({ id: '1', name: 'Notebook Updated', description: 'Notebook Dell Inspiron', price: 3000, stock: 10, category: 'Electronics' });
    });
