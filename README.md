...
API RESTful desenvolvida em Node.js utilizando Express, com estrutura organizada em rotas, controllers e services.
...
- Pronta para implementação de testes unitários
