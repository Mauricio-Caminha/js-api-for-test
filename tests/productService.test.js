...
describe("Product Service", () => {
  ...
  it("should create a new product", async () => {
    const newProductData = { name: 'Monitor', description: 'Monitor 24"', price: 1200, stock: 20, category: 'Electronics' };
  ...
  it("should update an existing product", async () => {
    const updatedProductData = { name: 'Updated Notebook', price: 3000 };
    const updatedProduct = await updateProduct('1', updatedProductData);
    expect(updatedProduct).toEqual(expect.objectContaining({ id: '1', name: 'Updated Notebook', price: 3000 }));
  });
